...
data class UserSettings(
    ...
    val transitionEffect: TransitionEffect = TransitionEffect.KEN_BURNS,
    ...
    val userSettingsFlow: Flow<UserSettings> = context.dataStore.data
        ...
        .map { prefs ->
            UserSettings(
                ...
                transitionEffect = prefs[PreferenceKeys.TRANSITION_EFFECT]?.let { runCatching { TransitionEffect.valueOf(it) }.getOrNull() } ?: TransitionEffect.KEN_BURNS,
